    ...
    async fn update_segments(
        ...
        for flush_segment_compaction in &req.flush_segment_compactions {
            ...
            let rows_affected = tx
                .update(update_stmt)
                .instrument(tracing::info_span!("update_segment_file_paths"))
                .await?;
            if rows_affected == 0 {
                return Err(SysDbError::NotFound(format!(
                    "segment '{}' not found",
            ...
            .read_write_transaction::<(), SysDbError, _>(|tx| {
                ...
                Box::pin(async move {
                    ...
                    let mut tenant_iter = tx
                        ...
                        .instrument(tracing::info_span!("check_tenant_exists"))
                        .await?;
                    ...
                    let mut iter = tx
                        .query(check_stmt)
                        .instrument(tracing::info_span!("check_database_exists"))
                        .await?;
